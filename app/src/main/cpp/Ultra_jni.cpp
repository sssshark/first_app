...
Java_com_kw_cpp_1test_FaceSDKNative_FaceDetectionModelInit(JNIEnv *env, jobject instance,
...
Java_com_kw_cpp_1test_FaceSDKNative_FaceDetect(JNIEnv *env, jobject instance, jbyteArray imageDate_,
...
JNIEXPORT jboolean JNICALL
Java_com_kw_cpp_1test_FaceSDKNative_FaceDetectionModelUnInit(JNIEnv *env, jobject instance) {
